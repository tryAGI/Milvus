...
namespace Milvus
{
    ...
    public sealed partial class CreateVectordbIndexesDescribeResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Milvus.IndexDetail> Data { get; set; }
        ...
        public CreateVectordbIndexesDescribeResponse(
            int code,
            global::System.Collections.Generic.IList<global::Milvus.IndexDetail> data)
        {
            this.Code = code;
