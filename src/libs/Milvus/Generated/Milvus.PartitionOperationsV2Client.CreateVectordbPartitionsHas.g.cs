...
namespace Milvus
{
    public partial class PartitionOperationsV2Client
    {
        ...
        private static readonly global::Milvus.EndPointSecurityRequirement s_CreateVectordbPartitionsHasSecurityRequirement0 =
        ...
        private static readonly global::Milvus.EndPointSecurityRequirement[] s_CreateVectordbPartitionsHasSecurityRequirements =
            new global::Milvus.EndPointSecurityRequirement[]
            {                s_CreateVectordbPartitionsHasSecurityRequirement0,
            };
        ...
        partial void ProcessCreateVectordbPartitionsHasResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Milvus.Has> CreateVectordbPartitionsHasAsync(
        ...
        {
            var __response = await CreateVectordbPartitionsHasAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Milvus.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Milvus.AutoSDKHttpResponse<global::Milvus.Has>> CreateVectordbPartitionsHasAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Milvus.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateVectordbPartitionsHasSecurityRequirements,
                operationName: "CreateVectordbPartitionsHasAsync");
            ...
            if (requestTimeout != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVectordbPartitionsHasRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Milvus.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Milvus.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createVectordbPartitionsHas",
                                methodName: "CreateVectordbPartitionsHasAsync",
                                pathTemplate: "\"/v2/vectordb/partitions/has\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVectordbPartitionsHasResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Milvus.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateVectordbPartitionsHasResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Milvus.Has.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Milvus.AutoSDKHttpResponse<global::Milvus.Has>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Milvus.Has.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
