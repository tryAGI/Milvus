...
namespace Milvus
{
    public partial class CollectionOperationsV2Client
    {
        ...
        private static readonly global::Milvus.EndPointSecurityRequirement s_CreateVectordbCollectionsReleaseSecurityRequirement0 =
        ...
        private static readonly global::Milvus.EndPointSecurityRequirement[] s_CreateVectordbCollectionsReleaseSecurityRequirements =
            new global::Milvus.EndPointSecurityRequirement[]
            {                s_CreateVectordbCollectionsReleaseSecurityRequirement0,
            };
        partial void PrepareCreateVectordbCollectionsReleaseArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? requestTimeout,
            global::Milvus.CreateVectordbCollectionsReleaseRequest request);
        partial void PrepareCreateVectordbCollectionsReleaseRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? requestTimeout,
            global::Milvus.CreateVectordbCollectionsReleaseRequest request);
        partial void ProcessCreateVectordbCollectionsReleaseResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateVectordbCollectionsReleaseResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> CreateVectordbCollectionsReleaseAsync(
        ...
        {
            var __response = await CreateVectordbCollectionsReleaseAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Milvus.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Milvus.AutoSDKHttpResponse<string>> CreateVectordbCollectionsReleaseAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateVectordbCollectionsReleaseArguments(
            ...
            var __authorizations = global::Milvus.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateVectordbCollectionsReleaseSecurityRequirements,
                operationName: "CreateVectordbCollectionsReleaseAsync");
            ...
            if (requestTimeout != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVectordbCollectionsReleaseRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Milvus.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Milvus.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createVectordbCollectionsRelease",
                                methodName: "CreateVectordbCollectionsReleaseAsync",
                                pathTemplate: "\"/v2/vectordb/collections/release\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVectordbCollectionsReleaseResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Milvus.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateVectordbCollectionsReleaseResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Milvus.AutoSDKHttpResponse<string>(
        ...
        public async global::System.Threading.Tasks.Task<string> CreateVectordbCollectionsReleaseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Milvus.CreateVectordbCollectionsReleaseRequest
            {
                DbName = dbName,
                CollectionName = collectionName,
            };

            return await CreateVectordbCollectionsReleaseAsync(
                requestTimeout: requestTimeout,
                request: __request,
                requestOptions: requestOptions,
