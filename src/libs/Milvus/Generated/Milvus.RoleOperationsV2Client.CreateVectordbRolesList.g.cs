...
namespace Milvus
{
    public partial class RoleOperationsV2Client
    {
        ...
        private static readonly global::Milvus.EndPointSecurityRequirement s_CreateVectordbRolesListSecurityRequirement0 =
        ...
        private static readonly global::Milvus.EndPointSecurityRequirement[] s_CreateVectordbRolesListSecurityRequirements =
            new global::Milvus.EndPointSecurityRequirement[]
            {                s_CreateVectordbRolesListSecurityRequirement0,
            };
        ...
        {
            await CreateVectordbRolesListAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Milvus.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Milvus.AutoSDKHttpResponse> CreateVectordbRolesListAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Milvus.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateVectordbRolesListSecurityRequirements,
                operationName: "CreateVectordbRolesListAsync");
            ...
            if (requestTimeout != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVectordbRolesListRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Milvus.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Milvus.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createVectordbRolesList",
                                methodName: "CreateVectordbRolesListAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVectordbRolesListResponse(
                    httpClient: HttpClient,
