...
namespace Milvus
{
    public partial class PartitionOperationsV2Client
    {
        ...
        partial void PrepareCreateVectordbPartitionsReleaseRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? requestTimeout,
            global::Milvus.PartitionNames request);
        partial void ProcessCreateVectordbPartitionsReleaseResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateVectordbPartitionsReleaseAsync(
        ...
        {
            await CreateVectordbPartitionsReleaseAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Milvus.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Milvus.AutoSDKHttpResponse> CreateVectordbPartitionsReleaseAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateVectordbPartitionsReleaseArguments(
            ...
            if (requestTimeout != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVectordbPartitionsReleaseRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Milvus.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Milvus.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createVectordbPartitionsRelease",
                                methodName: "CreateVectordbPartitionsReleaseAsync",
                                pathTemplate: "\"/v2/vectordb/partitions/release\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVectordbPartitionsReleaseResponse(
                    httpClient: HttpClient,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await CreateVectordbPartitionsReleaseAsync(
                requestTimeout: requestTimeout,
                request: __request,
                requestOptions: requestOptions,
